...
import com.pack.guide.lifecycle.FragmentLifecycleAdapter;
import com.pack.guide.lifecycle.ListenerFragment;
import com.pack.guide.lifecycle.V4ListenerFragment;
...
import com.pack.guide.util.DisplayUtil;
...
public class Controller {
    ...
    public Controller(Builder builder) {
        ...
        this.fragment = builder.myFragment;
    ...
    private void addCustomToLayout(final GuideLayout guideLayout, GuidePage guidePage) {
        ...
        if (layoutResId != 0) {
            ...
            params.bottomMargin = DisplayUtil.getNavigationBarHeight(activity);
